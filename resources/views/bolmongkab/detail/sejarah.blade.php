      ...
      <nav class="nav-menu d-none d-lg-block">
        ...
        <ul>
          ...
          <li class="drop-down"><a href="#">Pemerintah</a>
            <ul>
              ...
              <li class="drop-down"><a href="#">Pimpinan</a>
                <ul>
                  <li><a href="bupati.html">Bupati</a></li>
                  <li><a href="wakilbupati.html">Wakil Bupati</a></li>
              ...
              <li class="drop-down"><a href="#">Perangkat Daerah</a>
                <ul>
                  ...
                  <li><a href="dinas.html">Dinas</a></li>
                  <li><a href="badandaerah.html">Badan Daerah</a></li>
          ...
          <li class="drop-down"><a href="#">Layanan dan Informasi</a>
            <ul>
              <li><a href="rpjmd.html">RPJMD</a></li>
              <li><a href="puskesmas.html">Puskesmas</a></li>
          ...
          <li class="drop-down"><a href="#">Datang dan Kunjungi</a>
            <ul>
              <li><a href="ruangdata.html">Ruang Data</a></li>
  ...
  <main id="main">
    ...
    <section id="sejarah" class="sejarah">
      ...
      <p>Setelah Proklamasi 17 Agustus 1945, Bolaang Mongondow menjadi bagian wilayah Propinsi Sulawesi yang berpusat di Makassar.
        ...
        Seiring dengan Nuansa Reformasi dan Otonomi Daerah, telah dilakukan pemekaran wilayah dengan terbentuknya Kabupaten Bolaang Mongondow Utara melalui Undang-Undang RI No. 10 Tahun 2007 dan Kota Kotamobagu melalui Undang-Undang RI No. 4 Tahun 2007 sebagai hasil pemekaran dari Kabupaten Bolaang Mongondow. Tujuan utama pembentukan Kabupaten Bolmong Utara dan Kota Kotamobagu adalah untuk memajukan daerah, membangun kesejahteraan rakyat, memudahkan pelayanan, dan memobilisasi pembangunan bagi terciptanya kesejahteraan serta kemakmuran rakyat totabuan.
        <br><br>
        
        Semangat untuk memperoleh kesetaraan pemerintahan, ekonomi, sosial dan politik telah membawa Kabupaten Bolaang Mongondow mekar menjadi 4 Kabupaten dan 1 Kota yang menyebabkan berpindahnya ibukota pemerintahan dari Kecamatan kotamobagu ke Ibukota yang baru yaitu di kecamatan Lolak. Ini ditandai dengan terbitnya Undang-undang Republik Indonesia Nomor 4 Tahun 2007 tentang Pembentukan Kota Kotamobagu, Undang-undang Republik Indonesia Nomor 10 Tahun 2007 tentang Pembentukan Kabupaten Bolaang Mongondow Utara, Undang-undang Republik Indonesia Nomor 29 Tahun 2008 tentang Pembentukan Kabupaten Bolaang Mongondow Timur, serta Undang-undang Nomor 30 Tahun 2008 tentang Pembentukan Kabupaten Bolaang Mongondow Selatan.</p>
      <div class="accordion" id="accordionExample">
        <div class="card">
          ...
          <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
            <div class="card-body">
              Suku Mongondow dalam kehidupan keseharian menggunakan bahasa Mongondow, bahasa Bolango dan bahasa Bintauna. Secara linguistik, bahasa-bahasa ini masuk kedalam Rumpun bahasa Filipina, bersama dengan Bahasa Gorontalo, Bahasa Minahasa dan Bahasa Sangir. Suku Mongondow juga menggunakan Bahasa Melayu Manado dalam komunikasi mereka dengan masyarakat Sulawesi Utara lainnya.
            </div>
          </div>
        </div>
        <div class="card">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
            <div class="card-body">
              Kabupaten Bolaang Mongondow terdiri dari 15 kecamatan, 2 kelurahan, dan 200 desa. Pada tahun 2017, jumlah penduduknya mencapai 246.282 jiwa dengan luas wilayah 2.871,65 km² dan sebaran penduduk 86 jiwa/km².
            </div>
          </div>
        </div>
        <div class="card">
            ...
            <div class="card-body">
              <table class="table">
                <thead>
                  <tr>
                    <th scope="col">No</th>
                    <th scope="col">Seni Sastra</th>
                    <th scope="col">Seni Suara</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
